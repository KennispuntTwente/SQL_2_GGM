...
from sql_to_staging.functions.engine_loaders import load_source_connection
...
if os.path.exists("sql_to_staging/.env"):
    load_dotenv(dotenv_path="sql_to_staging/.env")
    logging.getLogger(__name__).info(
        "Loaded environment variables from sql_to_staging/.env"
    )
...
setup_logging(app_name="sql_to_staging", cfg_parsers=[cfg])
